...
$query = mysqli_query($conn, "SELECT * FROM cuti WHERE status='Menunggu Kaprodi' ORDER BY tanggal_pengajuan DESC");
?>
<!DOCTYPE html>
<html lang="id">
    ...
    <div class="main-content">
        <div class="card mb-4 border-0 shadow-sm">
            <div class="card-body p-4">
                <h4 class="mb-0 text-primary fw-bold">Daftar Pengajuan Cuti (Butuh Persetujuan Kaprodi)</h4>
            </div>
        </div>
                ...
                <table class="table table-hover mb-0 text-center align-middle">
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            <a href="detail.php?id=<?= $d['id_cuti']; ?>" class="btn btn-sm btn-info text-white fw-bold px-3">Lihat</a>
                                            <a href="setujui.php?id=<?= $d['id_cuti']; ?>" class="btn btn-sm btn-success fw-bold px-3" onclick="return confirm('Setujui pengajuan ini?');">Setujui</a>
                            ...
                            ?>
                            <tr>
                                <td colspan="8" class="py-5 text-muted fw-semibold">Tidak ada pengajuan yang menunggu persetujuan Kaprodi saat ini.</td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
