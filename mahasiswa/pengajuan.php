...
");
$sedang_cuti = mysqli_num_rows($cek_aktif) > 0;
    ...
    <div class="main-content">
        ...
        <div class="form-card border-0">
            <?php if ($sedang_cuti): ?>
                ...
                <div class="alert alert-warning p-4 mb-0 border-0 rounded-3">
                    <h5 class="fw-bold text-dark d-flex align-items-center gap-2 mb-3">
                        ...
                        Tidak Dapat Mengajukan Cuti Baru
                    </h5>
                    <p class="text-dark mb-0">
                        Anda tidak dapat membuat pengajuan baru saat ini karena Anda <strong>masih memiliki pengajuan yang sedang diproses</strong> atau <strong>masih dalam periode cuti aktif</strong>.
                        Anda baru dapat mengajukan cuti kembali jika masa cuti Anda telah berakhir atau pengajuan Anda sebelumnya ditolak.
                    </p>
                    <hr>
                    <a href="riwayat.php" class="btn btn-dark fw-bold">Lihat Riwayat Pengajuan</a>
                </div>
